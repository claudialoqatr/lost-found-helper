...
interface IconPickerProps {
  ...
  /** Render as inline compact version without label */
  inline?: boolean;
}
 ...
 */
export function IconPicker({ value, onChange, inline = false }: IconPickerProps) {
    ...
    return (
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <button
            type="button"
            className="w-10 h-10 rounded-lg bg-accent/10 flex items-center justify-center flex-shrink-0 hover:bg-accent/20 transition-colors"
